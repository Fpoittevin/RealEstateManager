...
class ExMapViewActivity : BaseActivity(),
    OnMapReadyCallback,
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_map_view_ex)
        configureToolbar()
        observeConnexion()
    ...
    override fun onMapReady(map: GoogleMap) {
        this.map = map.apply {
            setOnCameraMoveListener(this@ExMapViewActivity)
            setOnMarkerClickListener(this@ExMapViewActivity)
